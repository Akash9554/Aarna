...
public class AddNewProductTypeActivity extends AppCompatActivity implements IApiCallback {
    ...
    private void selectImage() {
        if (checkPermissions()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(AddNewProductTypeActivity.this);
            ...
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int item) {
                    if (options[item].equals("Take Photo")) {
                        ...
                        fileUri = getOutputMediaFileUri(AddNewProductTypeActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_FROM_CAMERA && resultCode == RESULT_OK) {
            ...
            Glide.with(this).load(url).apply(new RequestOptions()).centerCrop().into(iv_product_picture);
    ...
    public void addtrasactionimage() {
        ...
        RequestBody id = RequestBody.create(MediaType.parse("text/plain"), file_id);
        RequestBody name = RequestBody.create(MediaType.parse("text/plain"), product_name);
        FunctionHelper.disable_user_Intration(this, "Loading..", getSupportFragmentManager());
        ApiCall.getInstance(this).add_transaction_image(imageData, name,id, this);
    ...
    public void onSuccess(Object type, Object data, Object extraData) {
        ...
        if (type.equals("add_transaction_image")) {
